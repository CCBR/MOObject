...
View the [reference](https://ccbr.github.io/MOObject/reference/index.html)
for a comprehensive list of functions exported by MOObject.
...
MOSuite depends on MOObject and wraps its functions, 
so if you're already using MOSuite,
you already have access to everything available in MOObject
